...
public interface SalidaProductoRepository extends CrudRepository< SalidaProducto, Long> {
 
		public Optional<SalidaProducto> findByFechadesalida(Date fechadesalida);
