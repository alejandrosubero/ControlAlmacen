...
public interface UserControlRepository extends CrudRepository< UserControl, Long> {
		...
		public Optional<UserControl> findByLastLoginDate(Date lastLoginDate);
		public List<UserControl> findByLastLoginDateContaining(Date lastLoginDate);
		public Optional<UserControl> findByLastOutSystem(Date lastOutSystem);
		public List<UserControl> findByLastOutSystemContaining(Date lastOutSystem);
		public Optional<UserControl> findByModificSystem(Boolean modificSystem);
