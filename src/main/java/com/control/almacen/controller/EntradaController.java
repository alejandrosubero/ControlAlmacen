...
public class EntradaController {
    ...
    @PostMapping("/newIngreso")
    private Boolean enterProducto(@RequestBody ProductoIngreso productoIngresoList) {
         return entradaService.saveEntradaProductoIngreso((ProductoIngreso) entradaValidationService.validation(productoIngresoList));
    }
...
//        EntityRespone entityRespone = mapperEntityRespone.setEntityT(entradaService.findByRelacionProducto((String) entradaValidationService.validation(codigoProducto)));
//        return new ResponseEntity<EntityRespone>(entityRespone, HttpStatus.OK);
//    }
//
//    @PostMapping("/findencargado")
//    private ResponseEntity<EntityRespone> findRelacionUser(@RequestBody String encargado) {
//        EntityRespone entityRespone = mapperEntityRespone.setEntityT(entradaService.findByRelacionUser((String) entradaValidationService.validation(encargado)));
//        return new ResponseEntity<EntityRespone>(entityRespone, HttpStatus.OK);
//    }
//
//
...
//        Date busca = (Date) entradaValidationService.validation(fechaingreso);
//        try {
