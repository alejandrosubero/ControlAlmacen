...
import com.control.almacen.entitys.Cliente;import java.util.regex.Pattern;
import org.springframework.stereotype.Service;
import com.control.almacen.pojo.ClientePojo;import com.control.almacen.pojo.ClientePojo;


    @Service
    public class ClienteValidation {

        public ClientePojo valida(ClientePojo cliente) {
        ClientePojo pojo = null;
        try {
             if (cliente != null) {
              if (
        cliente.getId() != null &&
