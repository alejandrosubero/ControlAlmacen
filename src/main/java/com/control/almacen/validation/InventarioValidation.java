...
import com.control.almacen.entitys.Inventario;import java.util.regex.Pattern;
import org.springframework.stereotype.Service;
import com.control.almacen.pojo.InventarioPojo;import com.control.almacen.pojo.InventarioPojo;import com.control.almacen.entitys.Producto;
...
import com.control.almacen.pojo.SalidaProductoPojo;
    ...
    @Service
    public class InventarioValidation {

        public InventarioPojo valida(InventarioPojo inventario) {
        InventarioPojo pojo = null;
        try {
             if (inventario != null) {
              if (
        inventario.getId() != null &&
        inventario.getNombre() != null &&
        inventario.getFechainventario() != null        ) {
        pojo = inventario;
         }
        }
            return pojo;
