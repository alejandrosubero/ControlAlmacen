...
import com.control.almacen.entitys.SalidaProducto;import java.util.regex.Pattern;
import org.springframework.stereotype.Service;
import com.control.almacen.pojo.SalidaProductoPojo;import com.control.almacen.pojo.SalidaProductoPojo;import com.control.almacen.entitys.Producto;
...
import com.control.almacen.pojo.ClientePojo;
    ...
    @Service
    public class SalidaProductoValidation {

        public SalidaProductoPojo valida(SalidaProductoPojo salidaproducto) {
        SalidaProductoPojo pojo = null;
        try {
             if (salidaproducto != null) {
              if (
        salidaproducto.getId() != null &&
        salidaproducto.getFechadesalida() != null        ) {
        pojo = salidaproducto;
         }
        }
            return pojo;
